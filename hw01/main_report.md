...
- Ảnh các Issues được ghi nhận trên GitHub:
![Issue1](./screenshots/req3/issue01.jpg)
![Issue2](./screenshots/req3/issue02.jpg)
---

## Phần 4: QA/QC role mindmap

- Mindmap do ChatGPT tạo: 
...
- Mindmap sửa lại theo phân tích trên: 
![Mindmap1](./mindmap/correct.png)
---
## AI Critique
...
---
## Git Commit Log
Repo link: https://github.com/NgThanhLuanK23HCMUS/23KTPM3-23127296-HW01

```
commit 700714db8e4272bdff7fe6b1ebfa98b60db0b610 (HEAD -> main, origin/main, origin/HEAD)
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Mon Jun 8 02:30:39 2026 +0700

    add audit report

commit 3fd4a94614311c478509c39463192f935c31c046
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Mon Jun 8 01:22:00 2026 +0700

    add qa/qc mindmap

commit 004f64e99c44eac67a1eafe9c4918ef5f65daa54
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Sun Jun 7 23:55:41 2026 +0700

    complete req3

commit 8bee9eddcba91f051921f5b26dc607486e6b0e51
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Sun Jun 7 03:21:55 2026 +0700

    add prompt log

commit 0e9842c32b3c44b1d71280ecfa9044a918bd0c18
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Sun Jun 7 02:49:13 2026 +0700

    complete req2

commit cea06e682600cd59a1d0c1393a1f076f83e115f6
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Sat Jun 6 22:29:15 2026 +0700

    add req 2 (to defect 10)

commit 546d21830714c7737f8e764563d6e875ba709e7b
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Sat Jun 6 16:23:12 2026 +0700

    req2 defect 1

commit c0529dbc659ee269f37f76427f57e8779078d1bb
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Sat Jun 6 16:06:31 2026 +0700

    add req2 draft

commit 4d970481196658f9000e845d30d2caf166c700bf
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Fri Jun 5 17:58:43 2026 +0700

    complete req1

commit 1a697218bda866ca815b88146ba887d5ac649014
Author: Nguyễn Thành Luân <161336959+NgThanhLuanK23HCMUS@users.noreply.github.com>
Date:   Thu Jun 4 23:35:57 2026 +0700

    add req 1 and report
```

---
## Appendix A: Prompt Log 
- Mô hình sử dụng: ChatGPT
- Prompt của Requirement 1: [Xem chi tiết](./ai_comply/prompt/requirement1_prompt_log.md)
- Prompt của Requirement 2: [Xem chi tiết](./ai_comply/prompt/requirement2_prompt_log.md)
- Prompt của Requirement 3: [Xem chi tiết](./ai_comply/prompt/requirement3_prompt_log.md)
- Prompt của Mindmap: [Xem chi tiết](./ai_comply/prompt/mindmap_prompt_log.md)
...
Artifact đã sửa đúng theo phản hồi của tôi: tập trung vào vai trò QA/QC thay vì mở rộng sang toàn bộ kiến thức kiểm thử. Tuy nhiên trong hình vẫn còn nhiều chỗ bị sai và đã đề cập ở phần QA/QC role mindmap.

#### (4) Reasoning

Theo ISTQB CTFL, testing có mục tiêu cung cấp thông tin về chất lượng, giảm rủi ro và hỗ trợ ra quyết định. Mindmap đã thể hiện đúng các ý chính này trong phần “Theo ISTQB”. Tuy nhiên các trách nhiệm của Quality Control chưa đúng khi phải "xác nhận sản phẩm đạt yêu cầu".

#### (5) Student fix

Đã sửa lại theo phân tích và đã thêm bản sửa ở phần QA/QC mindmap.
...
Artifact đáp ứng yêu cầu chỉnh report về tiếng Việt, đồng thời vẫn giữ các thuật ngữ kỹ thuật cần thiết như CVE, GHSA, RCE, SQL Injection và prompt injection. Tuy nhiên khi dịch các thuật ngữ thì AI lại bị hallucinate khiến dịch không chính xác.

#### (4) Reasoning

Theo ISTQB, tài liệu kiểm thử và báo cáo cần rõ ràng, nhất quán và dễ hiểu với đối tượng đọc. Việc Việt hóa các nhãn chính giúp report thống nhất hơn, trong khi vẫn giữ thuật ngữ kỹ thuật để tránh làm sai nghĩa chuyên môn.

#### (5) Student fix

Sửa thêm một số từ bị AI dịch sai như "thiết bị VPN".
...
### Audit Entry 05 – Requirement 3 Excel Test Cases cho tai nghe Rapoo VH520C
...
Artifact đúng yêu cầu vì chỉ chứa các test case đã tạo trước đó và được chuyển sang định dạng Excel để dễ nộp hoặc tổng hợp nhưng vẫn chưa đủ các test case.

#### (4) Reasoning

Theo ISTQB, testware có thể bao gồm test cases, test data, test procedures và test execution results. Việc chuyển test case sang Excel không làm thay đổi logic kiểm thử, nhưng giúp quản lý và theo dõi test case dễ hơn.

#### (5) Student fix

Tôi đã thực hiện thêm 5 test case không do AI tạo vào file.


---

### Audit Entry 06 – Requirement 3 Prompt Log có timestamp
...
### Audit Entry 07 – Mindmap Prompt Log có timestamp
...
### Audit Entry 08 – Requirement 1 Report Filled từ 10 screenshot tuyển dụng

#### (1) Prompt + tool

- **Tool:** ChatGPT
- **Source log:** `requirement1_prompt_log.md`
...
AI điền thông tin 10 tin tuyển dụng QA/QC vào report và tạo các artifact:
...
- Lương
- Địa điểm
- Ngày đăng hoặc hạn nộp
- Một số kỹ năng/tag như QA QC, Automation Test, AI, SQL, API, Playwright, Selenium
- Mô tả công việc và kỹ năng yêu cầu cho từng tin
```
...
Artifact có lỗi quan trọng về tính xác thực dữ liệu. Sau khi sinh viên hỏi lại, AI thừa nhận một số phần mô tả công việc và kỹ năng yêu cầu không lấy trực tiếp từ screenshot mà được suy luận từ tiêu đề/tag tuyển dụng hoặc từ mô tả phổ biến của vị trí QA/QC. Điều này làm report có nguy cơ ghi thông tin chưa được kiểm chứng như dữ liệu thật.

#### (5) Student fix

Tôi đã sửa report theo hướng:
- Chỉ giữ các thông tin nhìn thấy trực tiếp trong screenshot hoặc đã kiểm chứng bằng link gốc.
- Không dùng các mô tả AI suy luận như thông tin đã xác minh.

---

### AI Accuracy Ratio

Tổng số AI-generated artifacts được đánh giá: **8**

| Verdict | Số lượng | Tỷ lệ | Ý nghĩa |
|---|---:|---:|---|
| VALID | 4 | 50.00% | Artifact do AI tạo ra phù hợp với yêu cầu và không cần chỉnh sửa lớn. |
| INVALID | 3 | 37.50% | Artifact có lỗi quan trọng, cần sinh viên phân tích và sửa lại trước khi nộp. |
| INCOMPLETE | 1 | 12.50% | Artifact đúng một phần nhưng chưa đầy đủ, cần bổ sung thêm nội dung thủ công. |
| **Total** | **8** | **100%** | Tổng số artifact đã được kiểm tra trong AI Audit Report. |


- AI nên sử dụng khi: thực hiện các công việc có tính quy trình như tạo report, tóm tắt một vấn đề, thiết kế test case.
- Không nên sử dụng AI khi: tìm hiểu vấn đề mang tính kỹ thuật cao, hỗ trợ trong các vấn đề liên quan đến bảo mật.