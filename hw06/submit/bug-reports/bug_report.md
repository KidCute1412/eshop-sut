...
- Severity: High.
- Local Newman evidence: `../newman/fr09-newman-report.json` logs `BUG-FR09-001` from FR09-001, FR09-004, FR09-006, and FR09-033.
...
- Severity: Critical.
- Local Newman evidence: `../newman/fr13-newman-report.json` logs `BUG-FR13-001` from ordinary-user access cases.
- GitHub issue screenshot/link: TODO - must be attached after creating the issue on GitHub.
...
- Severity: Medium.
- Local Newman evidence: `../newman/fr09-newman-report.json` logs `BUG-FR09-002` and related trust-boundary cases.
- GitHub issue screenshot/link: TODO - must be attached after creating the issue on GitHub.
