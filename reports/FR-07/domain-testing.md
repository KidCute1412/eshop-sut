...
| LOGOUT-LABEL-V01   | Output            | Logout label               | Logout action is labeled `Đăng xuất`.                                  | Valid    | Visible text `Đăng xuất`                                    | Authenticated cart page open.     | FR07-SH06                | `README.md` - FR-23                            | Exact required label.                                                     |
| LOGOUT-LABEL-I01   | Output            | Logout label               | Logout action uses forbidden label `Thoát`.                            | Invalid  | Visible text `Thoát`                                        | Authenticated cart page open.     | FR07-SH06                | `README.md` - FR-23                            | Explicit forbidden label.                                                 |
...
| LOGOUT-LABEL-V01   | Visible `Đăng xuất`                                       | Direct required navbar label.                       | Authenticated cart page open.               | UI         |
| LOGOUT-LABEL-I01   | Visible `Thoát`                                           | Explicit forbidden navbar label.                    | Authenticated cart page open.               | UI         |
...
- Added logout label partitions: `LOGOUT-LABEL-V01`, `LOGOUT-LABEL-I01` for `Đăng xuất` vs `Thoát`.
