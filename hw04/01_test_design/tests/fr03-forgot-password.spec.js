...
test.describe('FR-03 — Forgot Password UI', () => {
  ...
  test('FR03-TC12 reset step is missing a confirm-password field', async ({ page }) => {
    await page.goto(`${WEB}/forgot-password`);
    ...
    await expect(confirmField).toHaveCount(0); 
  });

  test('FR03-TC14b UI label documents a 4-digit OTP instead of the spec\'s 6 digits', async ({ page }) => {
    await page.goto(`${WEB}/forgot-password`);
