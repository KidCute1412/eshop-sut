# [23127404][FR-12] Anonymous product update returns HTTP 200

## Summary

Anonymous product update returns HTTP 200.

## Affected requirements and cases

- Requirement: FR-12
- Case ID: FR12-11
- Candidate ID: HW04-CAND-015

## Environment

- SUT revision: 6b884900be153b5af78a4865c9cca98cedcd9fc9
- Browser: Firefox 141.0 headless
- Execution command: `npx playwright test tests/fr12-access-control.spec.ts --project=firefox --grep FR12-11`
...
2. Execute case `FR12-11` with the command above.
...
**Critical** — Unauthenticated product mutation must be rejected; the endpoint accepts the request.

## Evidence

- Screenshot: `bugs/evidence/HW04-CAND-015/screenshot.png`
- Trace: `bugs/evidence/HW04-CAND-015/trace.zip`
- Case evidence: `bugs/evidence/HW04-CAND-015/evidence.json`
