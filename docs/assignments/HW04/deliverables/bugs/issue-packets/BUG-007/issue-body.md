# [23127404][FR-10] User cancellation of shipping order returns HTTP 200

## Summary

User cancellation of shipping order returns HTTP 200.

## Affected requirements and cases

- Requirement: FR-10
- Case ID: FR10-12
- Candidate ID: HW04-CAND-009

## Environment

- SUT revision: 6b884900be153b5af78a4865c9cca98cedcd9fc9
- Browser: Firefox 141.0 headless
- Execution command: `npx playwright test tests/fr10-order-state-machine.spec.ts --project=firefox --grep FR10-12`
...
2. Execute case `FR10-12` with the command above.
...
**High** — Shipping orders must reject user cancellation; a successful response violates the state transition contract.

## Evidence

- Screenshot: `bugs/evidence/HW04-CAND-009/screenshot.png`
- Trace: `bugs/evidence/HW04-CAND-009/trace.zip`
- Case evidence: `bugs/evidence/HW04-CAND-009/evidence.json`
