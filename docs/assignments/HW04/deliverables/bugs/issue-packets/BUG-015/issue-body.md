# [23127404][FR-12] Regular user JWT creates a category

## Summary

Regular user JWT creates a category.

## Affected requirements and cases

- Requirement: FR-12
- Case ID: FR12-14
- Candidate ID: HW04-CAND-017

## Environment

- SUT revision: 6b884900be153b5af78a4865c9cca98cedcd9fc9
- Browser: Firefox 141.0 headless
- Execution command: `npx playwright test tests/fr12-access-control.spec.ts --project=firefox --grep FR12-14`
...
2. Execute case `FR12-14` with the command above.
...
**Critical** — Category creation must require an admin role; a regular JWT is accepted.

## Evidence

- Screenshot: `bugs/evidence/HW04-CAND-017/screenshot.png`
- Trace: `bugs/evidence/HW04-CAND-017/trace.zip`
- Case evidence: `bugs/evidence/HW04-CAND-017/evidence.json`
