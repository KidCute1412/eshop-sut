...
- Requirement: FR-12
- Case ID: FR12-06
- Candidate ID: HW04-CAND-012

## Environment

- SUT revision: 6b884900be153b5af78a4865c9cca98cedcd9fc9
- Browser: Firefox 141.0 headless
- Execution command: `npx playwright test tests/fr12-access-control.spec.ts --project=firefox --grep FR12-06`
...
2. Execute case `FR12-06` with the command above.
...
**Critical** — Admin-order listing must require an admin role; a regular JWT receives protected data.

## Evidence

- Screenshot: `bugs/evidence/HW04-CAND-012/screenshot.png`
- Trace: `bugs/evidence/HW04-CAND-012/trace.zip`
- Case evidence: `bugs/evidence/HW04-CAND-012/evidence.json`
