...
| `HW04-CAND-008` | FR-10 | `FR10-11` | Chromium, Firefox, WebKit | Awaiting deduplication/filing | **PENDING** | No |
| `HW04-CAND-009` | FR-10 | `FR10-12` | Chromium, Firefox, WebKit | Awaiting deduplication/filing | **PENDING** | No |
...
|---|---|---|---|---|---|---|---|---|---|
| `BUG-___` | **PENDING** | **PENDING** | **PENDING** | **PENDING** | **PENDING — n/n** | **PENDING** | **PENDING** | **PENDING — date/viewer** | Open / Fixed / Closed / Rejected |
