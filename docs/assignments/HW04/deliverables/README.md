...
| `23127404_HW04_AI_Automation_100.zip` | Final self-assessed submission archive | Generated and structurally inspected; final timestamp/link checks remain student-controlled |
...
Do not submit this folder as complete until the final ISO 8601 submission timestamp is recorded, the YouTube and GitHub Issue links/attachments are checked while logged out, and the student approves the generated `23127404_HW04_AI_Automation_100.zip`. Follow `../specs/manual.md`; preserve the validated reports and do not recalculate totals from superseded runs.
