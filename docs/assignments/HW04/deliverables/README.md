...
| `23127404_HW04_AI_Automation_100.zip` | Final self-assessed submission archive target | Not yet generated; run `npm run package:submission` after final manual checks |
...
The following self-assessment reflects the evidence currently present in this package. The final archive should use suffix `100`; the four-day history limitation remains disclosed for reviewer transparency.
...
|  | **Total** | **100** | **100 / 100 (self-assessed)** | Four-day Git-history limitation disclosed; student-selected self-assessment |

## Submission gate

Do not submit this folder as complete until the final ISO 8601 submission timestamp is recorded, the YouTube and GitHub Issue links/attachments are checked while logged out, the `23127404_HW04_AI_Automation_100.zip` archive is generated and inspected, and the student approves the final package. Follow `../specs/manual.md`; preserve the validated reports and do not recalculate totals from superseded runs.
