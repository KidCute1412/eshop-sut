...
The workflow is included in `cicd/workflows/api-tests.yml`. The all-pass evidence is commit [`d07a9b1`](https://github.com/KidCute1412/eshop-sut/commit/d07a9b1) and its [GitHub Actions run](https://github.com/KidCute1412/eshop-sut/actions/runs/32665200965/job/97257113623). The required intentional red evidence is commit [`aa32d91`](https://github.com/KidCute1412/eshop-sut/commit/aa32d91) and its [GitHub Actions run](https://github.com/KidCute1412/eshop-sut/actions/runs/32665781240/job/97258816558): it intentionally expected `999` for `TC-LOGIN-01` and received `200`. The current test data restores the correct `200` expectation; authentic captures are in `cicd/screenshots/`. The reusable generator and its pseudocode are in `agent-skills/api-test-generator/`; the diagram source is preserved as Mermaid. Video: [https://youtu.be/RjtRRfqsz7s](https://youtu.be/RjtRRfqsz7s).
