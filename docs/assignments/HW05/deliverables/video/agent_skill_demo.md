...
The skill is intentionally evidence-preserving: it may guide plan design and analysis but refuses to invent execution numbers, screenshots, video URLs, or GitHub Issue URLs.
