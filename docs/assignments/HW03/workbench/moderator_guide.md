...
Explain that the product—not the participant—is being evaluated. Ask the participant to think aloud and clarify that the moderator will intervene only when continued progress is no longer possible.
...
1. Administer the ten SUS questions immediately after task completion.
2. Ask the four probes covering clarity, error recovery, speed, and trust.
3. Invite one final recommendation, confirm that the recording was saved, and thank the participant.
